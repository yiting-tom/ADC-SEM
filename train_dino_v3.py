#!/usr/bin/env python3
"""
DINOv3-style SSL training CLI for TinyViT with multi-channel input.

Examples:
  python train_dino_v3.py --data_path ./data --file_extension npy --num_channels 15
  python train_dino_v3.py --data_path ./tiff_data --file_extension tiff --epochs 50
  python train_dino_v3.py --data_path ./dataset.h5 --use_h5 --h5_dataset_key images
"""
...
from dino_v3_training import DINOv3TrainConfig, DINOv3Trainer


def parse_args():
    p = argparse.ArgumentParser(description="Train TinyViT with DINOv3-style SSL")
    ...
    p.add_argument("--local_crops", type=int, default=8)
    ...
    p.add_argument("--save_name", type=str, default="tinyvit_dino_v3_backbone.pth")
...
def main():
    ...
    model, metrics = DINOv3Trainer(cfg).train()

    # Save backbone (student)
